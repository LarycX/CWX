...
const computeFrequencyFromScroll = ({
  ...
  for (let i = 0; i < bandSegments.length; i += 1) {
    ...
    if (contentX >= band.startX && contentX <= band.endX) {
      const offsetMHz2 = (contentX - band.startX) / pxPerMHz;
      return snapFrequency(band, band.min + offsetMHz2);
    }
...
const scrollLeftForFrequency = ({
  ...
  const band = bandSegments.find((segment2) => freq >= segment2.min && freq <= segment2.max);
...
exports.buildBandSegments = buildBandSegments;
exports.buildTicks = buildTicks;
exports.computeFrequencyFromScroll = computeFrequencyFromScroll;
exports.scrollLeftForFrequency = scrollLeftForFrequency;
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/index/logic/spectrum.js.map
