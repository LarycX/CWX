...
// ../../../../../../Users/liruixiang/Desktop/CWX/CWX/node_modules/morse-decoder/src/index.js
var require_src = __commonJS({
  "../../../../../../Users/liruixiang/Desktop/CWX/CWX/node_modules/morse-decoder/src/index.js"(exports, module) {
    var baseCharacters = {
      "1": {
        "A": "01",
        "B": "1000",
    ...
    var getCharacters = (options) => Object.assign(Object.assign({}, baseCharacters), { "0": baseCharacters[options.priority], "1": Object.assign(Object.assign({}, baseCharacters["1"]), { [options.separator]: options.space }) });
    var getMappedCharacters = (options, usePriority) => {
      const mapped = {};
    ...
    var getOptions = (opts = {}) => {
      ...
      const options = Object.assign(Object.assign({}, opts), { dash: opts.dash || "-", dot: opts.dot || ".", space: opts.space || "/", separator: opts.separator || " ", invalid: opts.invalid || "#", priority: opts.priority || 1, wpm: opts.wpm, unit: opts.unit || 0.08, fwUnit: opts.fwUnit || opts.unit || 0.08, volume: opts.volume || 100, oscillator: Object.assign(Object.assign({}, opts.oscillator), {
        type: ((_a = opts.oscillator) === null || _a === void 0 ? void 0 : _a.type) || "sine",
        frequency: ((_b = opts.oscillator) === null || _b === void 0 ? void 0 : _b.frequency) || 500,
        onended: ((_c = opts.oscillator) === null || _c === void 0 ? void 0 : _c.onended) || null
        // event that fires when the tone has stopped playing
      }) });
      return options;
    };
    var getGainTimings = (morse, opts, currentTime = 0) => {
      const timings = [];
      ...
      timings.push([0, time]);
      const tone = (i) => {
        timings.push([1 * (opts.volume / 100), currentTime + time]);
        time += i * unit;
      };
      const silence = (i) => {
      ...
      for (let i = 0, addSilence = false; i <= morse.length; i++) {
        if (morse[i] === opts.space) {
          ...
          if (addSilence)
            ...
            addSilence = true;
          tone(3);
        } else if (typeof morse[i + 1] !== "undefined" && morse[i + 1] !== opts.space && (typeof morse[i - 1] !== "undefined" && morse[i - 1] !== opts.space)) {
          gap(3);
          addSilence = false;
        }
      }
    ...
    var encodeWAV = (sampleRate, samples) => {
    ...
    ((name, root, factory) => {
      ...
      const encode = (text, opts) => {
        ...
        const characters2 = getCharacters(options);
        return [...text.replace(/\s+/g, options.separator).trim().toLocaleUpperCase()].map(function(character) {
          for (const set in characters2) {
            if (typeof characters2[set] !== "undefined" && typeof characters2[set][character] !== "undefined") {
              return characters2[set][character];
            }
          }
      ...
      const decode = (morse, opts) => {
        ...
        return morse.replace(/\s+/g, options.separator).trim().split(options.separator).map(function(characters2) {
          if (typeof swapped[characters2] !== "undefined") {
            return swapped[characters2];
          }
          return options.invalid;
        }).join("");
      };
...
//# sourceMappingURL=morse-decoder.js.map
