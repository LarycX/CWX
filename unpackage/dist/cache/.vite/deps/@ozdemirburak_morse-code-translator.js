...
// ../../../../../../Users/liruixiang/Desktop/CWX/CWX/node_modules/@ozdemirburak/morse-code-translator/dist/morse-code-translator.es.js
var b = {
  1: {
...
var C = (e = {}) => {
  ...
  return {
    ...
    oscillator: {
      ...e.oscillator,
      type: ((_a = e.oscillator) == null ? void 0 : _a.type) || "sine",
      // sine, square, sawtooth, triangle
      frequency: ((_b = e.oscillator) == null ? void 0 : _b.frequency) || 500,
      // value in hertz
      onended: ((_c = e.oscillator) == null ? void 0 : _c.onended) || null
...
var K = (e, t, n = 0) => {
  ...
  }, i = (o) => T(t.volume / 100, o), m = (o) => T(0, o), y = (o) => T(0, o, false);
  for (let o = 0, u = false; o <= e.length; o++) {
    const a = e[o], f = e[o + 1], h = e[o - 1];
    a === t.space ? (y($), u = false) : a === t.dot ? (u && m(O), i(F), u = true) : a === t.dash ? (u && m(O), i(j), u = true) : f !== void 0 && f !== t.space && h !== void 0 && h !== t.space && (y(z), u = false);
  }
  return [s, c];
};
var Q = (e, t) => {
  ...
  return m(0, "RIFF"), i.setUint32(4, c - 8, true), m(8, "WAVE"), m(12, "fmt "), i.setUint32(16, 16, true), i.setUint16(20, 1, true), i.setUint16(22, U, true), i.setUint32(24, e, true), i.setUint32(28, r, true), i.setUint16(32, s, true), i.setUint16(34, M, true), m(36, "data"), i.setUint32(40, w, true), y(44, t), i;
};
var X = (e, t) => {
  ...
  const R = new Promise((l, p) => {
    m.start(0), i.startRendering(), i.oncomplete = (d) => {
      var _a;
      try {
        u = d.renderedBuffer, a = "ready", (_a = A.onready) == null ? void 0 : _a.call(A), l();
      } catch (_) {
        p(_);
      }
    ...
    return l.buffer = u, l.connect(r.destination), l.onended = () => {
      var _a;
      const p = P();
      a === "playing" && p >= c - 0.01 && (a = "stopped", f = 0, (_a = A.onended) == null ? void 0 : _a.call(A));
    }, l;
  }, S = async () => {
    var _a;
    if (await R, r.state === "suspended" && await r.resume(), a === "playing")
      return;
    (!o || o.buffer === null) && (o = D()), o.start(r.currentTime, f), h = r.currentTime - f, a = "playing", (_a = A.onstarted) == null ? void 0 : _a.call(A);
    const l = (c - f) * 1e3;
    g = window.setTimeout(() => {
      a === "playing" && v();
    }, l);
    ...
    var _a;
    a === "playing" && (g !== null && (clearTimeout(g), g = null), f = Math.min(r.currentTime - h, c), o && (o.stop(0), o = null), a = "paused", (_a = A.onpaused) == null ? void 0 : _a.call(A));
  }, v = (l = false) => {
    var _a;
    ...
    const p = a === "playing";
    a = "stopped", f = 0, h = 0, p && ((_a = A.onstopped) == null ? void 0 : _a.call(A)), l && (u = null);
  }, N = async (l) => {
    var _a;
    ...
    f = d, (_a = A.onseeked) == null ? void 0 : _a.call(A, d), p && (a = "paused", await S());
  }, V = () => {
    v(true), r.state !== "closed" && r.close();
...
//# sourceMappingURL=@ozdemirburak_morse-code-translator.js.map
