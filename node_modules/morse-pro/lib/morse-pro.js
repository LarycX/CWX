...
export default class Morse {
  ...
  _loadDictionaries() {
    ...
    this.text2morseD = {};
    this.morse2textD = {}; // Set up sensible default:
  ...
  _addDictionary(dict) {
    this.dictionary = { ...this.dictionary,
      ...dict
    }; // overwrite any existing keys with the new dict
  ...
  _input2output(tokens, dict) {
    ...
    for (let letters of tokens) {
      ...
      for (let letter of letters) {
        let char = '';
        let error = false; // These tests are a little complex because e.g. the american dictionary uses "s" and "S" in the Morse.
